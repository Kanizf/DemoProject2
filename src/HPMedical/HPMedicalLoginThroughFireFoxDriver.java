...
public class HPMedicalLoginThroughFireFoxDriver {
	...
	public static void main  (String [] args) throws Exception {
		...
		try {
			...
			//	waitSeconds(2);
				...
				System.out.println("The Log in Process is failed  --  The reason is title is not match with the expected result");
				driver.quit();
			}
